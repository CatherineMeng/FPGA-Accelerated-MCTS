    ...
    def run(self):
        ...
        while True:
            ...
            if command == "KillProc":
                ...
                done_expanded=done #if done after 1-step simulation in expansion, no need for simulation
                ...
                #first three for in-tree expansion, second two for in-tree backup
                # action is the original expanded action sent to worker. send back for ST ops.
                item2 = (action, done_expanded, params, reward, task_idx)
