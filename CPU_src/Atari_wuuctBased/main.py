...
def main():
    ...
    parser.add_argument("--MCTS-max-steps", type = int, default = 10000,
    ...
    parser.add_argument("--expansion-worker-num", type = int, default = 1, #we do not use exp workers now
                        help = "Number of expansion workers (default: 1)")
    parser.add_argument("--simulation-worker-num", type = int, default = 16, #we only use sim workers now
