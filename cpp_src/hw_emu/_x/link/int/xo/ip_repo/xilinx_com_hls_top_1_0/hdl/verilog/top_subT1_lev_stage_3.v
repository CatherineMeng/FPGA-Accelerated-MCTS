...
wire   [31:0] newind_4_fu_195_p2;
wire   [31:0] newind_fu_209_p2;
reg   [31:0] newind_reg_242;
reg   [31:0] ap_phi_mux_newind_6_phi_fu_140_p4;
reg   [31:0] newind_6_reg_137;
reg    ap_block_state1;
reg    ap_block_state2;
...
assign and_ln2_fu_181_p3 = {{grp_fu_146_p4}, {2'd0}};
...
assign childindexpipe_1_din = {{ap_phi_mux_newind_6_phi_fu_140_p4}, {pipeobj_depth_reg_223}};
...
assign newind_4_fu_195_p2 = (sub_ln413_fu_189_p2 + 32'd1);
...
assign sub_ln413_fu_189_p2 = (and_ln2_fu_181_p3 - pipeobj_ind_fu_160_p4);

assign zext_ln390_fu_175_p1 = IDR_wind_fu_171_p1;

endmodule //top_subT1_lev_stage_3
