...
entity top_subT1_lev_stage_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of top_subT1_lev_stage_4 is 
...
attribute shreg_extract : string;
    ...
    signal newind_1_fu_195_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal newind_fu_209_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal newind_reg_242 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_mux_newind_3_phi_fu_140_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal newind_3_reg_137 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal and_ln1_fu_181_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    newind_3_reg_137_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    and_ln1_fu_181_p3 <= (grp_fu_146_p4 & ap_const_lv2_0);
    ...
    ap_phi_mux_newind_3_phi_fu_140_p4_assign_proc : process(ap_CS_fsm_state2, ret_signal_V_reg_228, newind_reg_242, newind_3_reg_137)
    begin
    ...
    childindexpipe_1_din <= (ap_phi_mux_newind_3_phi_fu_140_p4 & pipeobj_depth_reg_223);
    ...
    newind_1_fu_195_p2 <= std_logic_vector(unsigned(sub_ln413_fu_189_p2) + unsigned(ap_const_lv32_1));
    ...
    sub_ln413_fu_189_p2 <= std_logic_vector(unsigned(and_ln1_fu_181_p3) - unsigned(pipeobj_ind_fu_160_p4));
