...
#define XTOP_CONTROL_ADDR_ADJ_LIST_DATA 0x10
#define XTOP_CONTROL_BITS_ADJ_LIST_DATA 64
#define XTOP_CONTROL_ADDR_FLUSHS_DATA   0x1c
#define XTOP_CONTROL_BITS_FLUSHS_DATA   32
