...
architecture behave of top_control_s_axi is
    ...
    constant ADDR_ADJ_LIST_DATA_0 : INTEGER := 16#10#;
    constant ADDR_ADJ_LIST_DATA_1 : INTEGER := 16#14#;
    constant ADDR_ADJ_LIST_CTRL   : INTEGER := 16#18#;
    constant ADDR_FLUSHS_DATA_0   : INTEGER := 16#1c#;
    constant ADDR_FLUSHS_CTRL     : INTEGER := 16#20#;
    ...
    signal int_adj_list        : UNSIGNED(63 downto 0) := (others => '0');
    signal int_flushs          : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_ADJ_LIST_DATA_0 =>
                        rdata_data <= RESIZE(int_adj_list(31 downto 0), 32);
                    when ADDR_ADJ_LIST_DATA_1 =>
                        rdata_data <= RESIZE(int_adj_list(63 downto 32), 32);
                    when ADDR_FLUSHS_DATA_0 =>
                        rdata_data <= RESIZE(int_flushs(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    adj_list             <= STD_LOGIC_VECTOR(int_adj_list);
    flushs               <= STD_LOGIC_VECTOR(int_flushs);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_ADJ_LIST_DATA_0) then
                    int_adj_list(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_adj_list(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_ADJ_LIST_DATA_1) then
                    int_adj_list(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_adj_list(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FLUSHS_DATA_0) then
                    int_flushs(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_flushs(31 downto 0));
                end if;
            end if;
        end if;
    end process;
