set moduleName subT1_lev_stage_1
set isTopModule 0
...
set C_modelName {subT1_lev_stage.1}
...
set C_modelArgList {
	...
	{ memoiz_array_par_ind int 32 regular {array 32 { 2 3 } 1 1 }  }
	{ memoiz_array_child_ind int 1 regular {array 32 { 2 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "childindexpipe_0", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "memoiz_array_par_ind", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "memoiz_array_child_ind", "interface" : "memory", "bitwidth" : 1, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ memoiz_array_par_ind_q0 sc_in sc_lv 32 signal 6 } 
	...
	{ memoiz_array_child_ind_q0 sc_in sc_lv 1 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "memoiz_array_par_ind_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "memoiz_array_par_ind", "role": "q0" }} , 
 	...
 	{ "name": "memoiz_array_child_ind_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "memoiz_array_child_ind", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lev4_numc_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lev4_ucta_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	memoiz_array_par_ind { ap_memory {  { memoiz_array_par_ind_address0 mem_address 1 5 }  { memoiz_array_par_ind_ce0 mem_ce 1 1 }  { memoiz_array_par_ind_we0 mem_we 1 1 }  { memoiz_array_par_ind_d0 mem_din 1 32 }  { memoiz_array_par_ind_q0 in_data 0 32 } } }
	memoiz_array_child_ind { ap_memory {  { memoiz_array_child_ind_address0 mem_address 1 5 }  { memoiz_array_child_ind_ce0 mem_ce 1 1 }  { memoiz_array_child_ind_we0 mem_we 1 1 }  { memoiz_array_child_ind_d0 mem_din 1 1 }  { memoiz_array_child_ind_q0 mem_dout 0 1 } } }
}
