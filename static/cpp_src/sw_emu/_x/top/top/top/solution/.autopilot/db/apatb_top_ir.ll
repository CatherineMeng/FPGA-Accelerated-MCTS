; ModuleID = '/home/myuan/Desktop/MCTS/FPGA-Accelerated-MCTS/cpp_src/sw_emu/_x/top/top/top/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<qdma_axis<20, 0, 0, 0>, 0>.18"(i20* %_V_data_V, i3* %_V_keep_V, i1* %_V_last_V, %"class.hls::stream<qdma_axis<20, 0, 0, 0>, 0>"* %0)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>.7"(%"class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>"* %1, i32* %_V_data_V1, i4* %_V_keep_V2, i1* %_V_last_V3)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>.7"(%"class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_last_V) unnamed_addr #2 {
entry:
  %1 = icmp eq %"class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>"* %0, null
  %2 = or i1 %1, false
  br i1 %2, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>.10"(%"class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>"* nonnull align 512 %0, i32* %_V_data_V, i4* %_V_keep_V, i1* %_V_last_V)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>.10"(%"class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>"* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", i32* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_last_V) unnamed_addr #3 {
entry:
  %1 = alloca %"class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>"
  %2 = alloca i32
  %3 = alloca i4
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<qdma_axis<20, 0, 0, 0>, 0>.18"(i20* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_last_V, %"class.hls::stream<qdma_axis<20, 0, 0, 0>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
  %1 = icmp eq %"class.hls::stream<qdma_axis<20, 0, 0, 0>, 0>"* %0, null
  %2 = or i1 false, %1
  br i1 %2, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<qdma_axis<20, 0, 0, 0>, 0>.21"(i20* %_V_data_V, i3* %_V_keep_V, i1* %_V_last_V, %"class.hls::stream<qdma_axis<20, 0, 0, 0>, 0>"* nonnull %0)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<qdma_axis<20, 0, 0, 0>, 0>.21"(i20* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i3* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_last_V, %"class.hls::stream<qdma_axis<20, 0, 0, 0>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
  %1 = alloca %"class.hls::stream<qdma_axis<20, 0, 0, 0>, 0>"
