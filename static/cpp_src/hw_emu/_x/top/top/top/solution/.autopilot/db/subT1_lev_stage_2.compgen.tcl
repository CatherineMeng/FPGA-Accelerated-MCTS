...
set ID 28
set hasByteEnable 0
set MemName top_subT1_lev_stage_2_lev3_numc_V_RAM_1P_URAM_1R1W
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $MemName BINDTYPE {storage} TYPE {ram_1p} IMPL {uram} LATENCY 2 ALLOW_PRAGMA 1
}
...
set ID 29
set hasByteEnable 0
set MemName top_subT1_lev_stage_2_lev3_ucta_V_RAM_1P_URAM_1R1W
set CoreName ap_simcore_mem
set PortList { 2 }
set DataWd 20
set AddrRange 27
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { memoiz_array_par_ind_address0 { O 5 vector } memoiz_array_par_ind_ce0 { O 1 bit } memoiz_array_par_ind_we0 { O 1 bit } memoiz_array_par_ind_d0 { O 32 vector } memoiz_array_par_ind_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { memoiz_array_child_ind_address0 { O 5 vector } memoiz_array_child_ind_ce0 { O 1 bit } memoiz_array_child_ind_we0 { O 1 bit } memoiz_array_child_ind_d0 { O 1 vector } memoiz_array_child_ind_q0 { I 1 vector } } \
} "
} else {
